...
class MigrateUsers extends Command {
    ...
    public function handle() {
        ...
        $Post->content = '"""
      >Приветствую 🫶🏻 на Бесплатной информационной площадке  с пользой для здоровья\.\n
      Скачай свой гайд "7 главных анализов ЖКТ" пользуйся будь здоров 🧑\u{200D}⚕️ ||✔️ Появились вопросы задай  в чате на канале ||👇\n
      \n
